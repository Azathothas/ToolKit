...
⚠ **It is not complete and cannot be.** Some rows were seeded from classes that
recur across projects; most were added here, by a review that found the defect.
A class nobody has met yet has no row, so a green grep against this page is
evidence about the classes below it and about nothing else.
