...
# .yml and .mjs in the tree unchecked. Measured in `Azathothas/TEMPLATE` on
# 2026-08-28, where this check was written: 2290 characters outside the five,
# in 22 files, and every one of them was in a script rather than a document.
#
# ⭐ THIS TREE IS THE THIRD TO REPRODUCE THAT SHAPE, and the number is its own.
# First run here, 2026-08-29, before anything was cleaned: 164 characters
# across 28 files and 3 files over the density ceiling. Every character was in
# a comment banner, and check-docs.sh had reported the tree clean throughout,
# because it reads markdown alone.
#
...
#
# ⚠ THIS TREE WAS NOT IN THAT SAMPLE. Measured here on 2026-08-29, three files
# were over the ceiling and all three are record files rather than references:
# `TODO/PROGRESS.md` at 33, `TODO/SUMMARY.md` at 43 and `TODO/bsd.md` at 33.
#
